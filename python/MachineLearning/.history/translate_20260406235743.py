...
def ensure_zh_en_model(local_model_path: str = None):
    ...
    if local_model_path is None:
        raise RuntimeError(
            "语言包未安装，请手动下载 .argosmodel 文件后，"
            "以路径作为参数调用：ensure_zh_en_model('/path/to/translate-zh_en.argosmodel')"
        )
...
if __name__ == "__main__":
    ...
    ensure_zh_en_model(local_model_path="/Users/yangpei/Downloads/translate-zh_en-1_9.argosmodel")
